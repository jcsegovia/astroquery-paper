...
\begin{itemize}
    ...
    \item \url{http://gea.esac.esa.int/archive-help/tutorials/python_cluster/index.html}: tutorial 
        focused on a scientific exploration exercise for a known cluster, the Pleiades (M45), 
        using data from the Gaia Archive.
\end{itemize}
